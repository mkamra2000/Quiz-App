...
function InstructionPage(props) {
  ...
  return (
    <div>
      ...
      <div className="m-8">
        <div className="tracking-wider text-2xl text-blue-dark font-bold font-serif">
          Important Instructions:-
        </div>
        <div>
          <span className="tracking-wider text-2xl text-blue-dark">&#8226;</span>
          <span className="tracking-wider text-xl text-blue-dark p-2">
        ...
        <div>
          ...
          <img
            ...
            width="800"
          ></img>
          <span className="tracking-wider text-2xl text-blue-dark pl-4">&#8226;</span>
          <span className="tracking-wider text-xl text-blue-dark p-2">
        ...
        <div>
          ...
          <br />
          <span className="tracking-wider text-2xl text-blue-dark pl-8">&#8226;</span>
          <span className="tracking-wider text-xl text-blue-dark p-4">
